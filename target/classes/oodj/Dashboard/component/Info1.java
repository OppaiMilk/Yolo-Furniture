...
public class Info1 extends javax.swing.JPanel {
    ...
    public void initEvent(TableActionEvent_SaleForm event, int row) {
    ...
    private void initComponents() {
        ...
        InfoButton.setIcon(new javax.swing.ImageIcon(getClass().getResource("/oodj/Dashboard/icon/Manufacturing.png"))); // NOI18N
