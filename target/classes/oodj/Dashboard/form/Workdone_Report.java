...
public class Workdone_Report {
    private List<SaleRecord> workdoneSaleRecords;
    ...
    public Workdone_Report(List<SaleRecord> workdoneSaleRecords) {
        this.workdoneSaleRecords = workdoneSaleRecords;
    }
    ...
    public void generateReportForSelectedMonth(String selectedMonth, String selectedYear, String staffRoles, String staffName) {
        ...
        String outputPath = "WorkDone Report/" + staffName + "_" + selectedMonth + "_" + selectedYear + "_WorkDone_Sale_Report.pdf";
        PDFGenerator.generateSaleReport(filteredRecords, outputPath, selectedMonth, selectedYear, staffRoles, staffName);

        System.out.println("Work Done Sale Report for " + selectedMonth + " " + selectedYear + " generated successfully!");
        
        // Display a JOptionPane with the success message and ask if the user wants to open the PDF
        int choice = JOptionPane.showConfirmDialog(null,
                "Work Done Sale Report for " + selectedMonth + " " + selectedYear + " generated successfully!\n"
    ...
    public void generateReportForSelectedYear(String selectedYear, String selectedMonth, String staffRoles, String staffName) {
        ...
        System.out.println("Work Done Sale Report for the year " + selectedYear + " generated successfully!");
    ...
    private List<SaleRecord> filterSaleRecordsByMonthAndYear(String selectedMonth, String selectedYear) {
        ...
        for (SaleRecord record : workdoneSaleRecords) {
            try {
